...
class Problem1(unittest.TestCase):
    ...
    def test1(self):
        command = "python nearest_insertion.py"
        sought = """(110.0, 225.0)
(161.0, 280.0)
(157.0, 443.0)
(283.0, 379.0)
...
Number of points = 10
"""
        got = run(command, open("data/tsp10.txt", "r").read())
        self.assertNotEquals(got, "__TIMEOUT__")
        self.assertEquals(got, sought)

    def test2(self):
        command = "python smallest_insertion.py"
        sought = """(110.0, 225.0)
(283.0, 379.0)
(306.0, 360.0)
(343.0, 110.0)
...
"""
        got = run(command, open("data/tsp100.txt", "r").read())
        self.assertNotEquals(got, "__TIMEOUT__")
